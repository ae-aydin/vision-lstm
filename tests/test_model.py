...
model = VisionLSTM2(dim=192, depth=2, patch_size=16,
                    input_shape=(3, 384, 384), output_shape=(1000,)).eval()
with torch.no_grad():
...
model = VisionLSTM2(dim=192, depth=12, patch_size=8,
                    input_shape=(3, 64, 64), output_shape=(200,))
